...
const solarityround = chrome.runtime.getURL('images/solarityround.png')
  ...
  return (
    <div className="!h-[95vh]">
      <div className='!w-full !h-full'>
        <div className="!flex !justify-center !pt-[27vh]">
          <img className="w-25 h-25" src={solarityround} width={100} height={100}/>
        </div>
        <div className="!text-gray-300 !text-center !text-3xl !font-medium !pt-2">
          Enter your name
        </div>
        <div className="!pt-[7vh] !px-5">
          <input
            type="text"
            value={name}
